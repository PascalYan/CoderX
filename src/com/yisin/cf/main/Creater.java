...
import com.yisin.cf.form.MySqlSetPanel;
import com.yisin.cf.util.CommonUtils;
import com.yisin.cf.util.Consts;
import com.yisin.cf.util.DateUtil;
import com.yisin.cf.util.FileUtils;
...
public class Creater {
	...
	public String createEntity() {
		...
		try {
			...
			content = Utililies.parseTemplate(content, "attr_list", createAttrList(hasDate, hasTimestamp));
	...
	public String createMapper() {
		...
		try {
			...
			// package
			content = Utililies.parseTemplate(content, "MapperPackage", ca.getMapPackage());
			content = Utililies.parseTemplate(content, "EntityPackage", ca.getEntityPackage());
	...
	public String createAttrList(boolean hasDate, boolean hasTimestamp) {
